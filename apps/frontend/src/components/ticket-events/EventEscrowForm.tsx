  ...
  return (
    <div className="rounded-lg bg-slate-50 p-4 dark:bg-slate-800/50">
      <div className="flex items-center gap-3 mb-4">
        <EventIcon className="h-5 w-5 text-emerald-500" />
...
/**
 * EventEscrowForm Component
 * 
 * Integrates Trustless Work escrow forms with event booking workflow
 */
export function EventEscrowForm({
  booking,
  room,
  event,
  escrowType,
    ...
    return (
      <Card>
        ...
        <CardContent className="space-y-6">
          <BookingSummary booking={booking} event={event} room={room} />
...
export default EventEscrowForm;
